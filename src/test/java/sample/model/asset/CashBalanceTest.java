...
public class CashBalanceTest extends EntityTestSupport {
    ...
    public void add() {
        tx(() -> {
            CashBalance cb = fixtures.cb("test1", LocalDate.of(2014, 11, 18), "USD", "10.02").save(rep);
    ...
    public void getOrNew() {
        tx(() -> {
            fixtures.cb("test1", LocalDate.of(2014, 11, 18), "JPY", "1000").save(rep);
            fixtures.cb("test2", LocalDate.of(2014, 11, 17), "JPY", "3000").save(rep);
